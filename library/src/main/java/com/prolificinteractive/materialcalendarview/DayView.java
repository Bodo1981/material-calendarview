...
class DayView extends CheckedTextView {
    ...
    private static Drawable generateBackground(int color, int fadeTime, Rect bounds) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawable.addState(new int[]{android.R.attr.state_pressed, android.R.attr.state_checked}, generateRippleDrawable(color, bounds));
        } else {
            drawable.addState(new int[]{android.R.attr.state_pressed, android.R.attr.state_checked}, generateCircleDrawable(color));
        }
